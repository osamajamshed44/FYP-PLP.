...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar bg-primary">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php" style="font-size: 22px;"><strong><?php echo $fullname;?></strong></a>
            <!-- Sidebar Toggle-->
                ...
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav" style="padding-left: 30px">
                            ...
                            <a href="../indexQ&A.php?userid=<?php echo $student_id; ?>" style="padding-left: 30px; color: white;">Ask Question</a>
                        </nav>
                    </div>
                </div>
            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        padding: 3px;">
                            <div class="container-fluid px-4">
                                <h1 class="mt-4">To Check  Course </h1>
                                <ol class="breadcrumb mb-4">
                            ...
                            <div class="container-fluid px-4">
                                <h1 class="mt-4">To Check Video Lecture </h1>
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item"><a
                                            href="index.html">Dashboard</a></li>
                            ...
                            <div class="container-fluid px-4">
                                <h1 class="mt-4">To Ask Question</h1>
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item"><a
                                            href="index.html">Dashboard</a></li>
