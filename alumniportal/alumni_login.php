      ...
      <div class="row">
        ...
        right: 0px;">
          <a style="text-decoration:none" href="../index.php">
            <div style="margin-left: 30px; color: #7d2ae8; text-align: center;">
              <h1>
                Bahria University Peer Learning Platform</h1>
            </div>
          </a>
        </div>
      </div>
        ...
        <div class="login-form">
          ...
          <form method="post" action="alumni_login.php">
            <div class="input-boxes">
              ...
              <div class="text sign-up-text">Don't have an account? <a href="alumni_registration.php">SignUp now</a>
              </div>
            </div>
          </form>
        </div>
