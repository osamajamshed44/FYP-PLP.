...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar bg-primary">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="alumni_index.html" style="font-size: 22px;"><strong><?php echo $fullname; ?></strong></a>
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0"
                id="sidebarToggle" href="#!" style="margin-left: 60px;"><i
                ...
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav" style="padding-left: 30px;">
                            <a href="alumni_index.html" class="active"
                                style="color: yellow; padding-left: 30px;">Home</a>
            ...
            <ul class="navbar-nav bg-dark ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end"
                        ...
                        <li><a class="dropdown-item" href="alumni_logout.php">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark"
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="indexofadmin.html">
                            ...
                            <a class="nav-link" href="tablesofteacher.html">
                                <div class="sb-nav-link-icon"><i
                                        class="fas fa-table"></i></div>
                                Strength Of Teacher
                            </a>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="dashboardwork"
                            style="border-style:outset; border-width: 5px; border-radius: 5px;
                        padding: 3px;">
                            <div class="container-fluid px-4">
                                <h1 class="mt-4">To Check Total Course </h1>
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item"><a
                                            href="indexofadmin.html">Dashboard</a></li>
                            ...
                            <div class="container-fluid px-4">
                                <h1 class="mt-4">To Check Total Strength Of
                                    Student's </h1>
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item"><a
                                            href="indexofadmin.html">Dashboard</a></li>
                            ...
                            <div class="container-fluid px-4">
                                <h1 class="mt-4">To Check Question & Answer</h1>
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item"><a
                                            href="indexofadmin.html">Dashboard</a></li>
